...
# govern an extension force-revealing its own Output channel — n8n-as-code does that on
...
WANT_TOP = {
    ...
    # extension force-revealing its own Output channel (n8n-as-code does exactly
